const About = () => {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl md:text-4xl font-bold mb-4 text-center">Passionate About Innovation</h1>
      <p className="text-lg md:text-xl mb-8 text-center">We are ProtoLaunch, a team of creators, engineers, and strategists committed to helping startups and entrepreneurs realize their visions through expert product development services.</p>

      <section className="mb-12">
        <h2 className="text-2xl md:text-3xl font-bold mb-4">Our Mission</h2>
        <p className="text-base md:text-lg">Our mission at ProtoLaunch is to empower startups and innovators by providing affordable, cutting-edge prototype and development services. We thrive on creating solutions that push boundaries and shape the future.</p>
      </section>

      <section className="mb-12">
        <h2 className="text-2xl md:text-3xl font-bold mb-4">Our Vision</h2>
        <p className="text-base md:text-lg">To become the leading partner for startup prototype and development services, renowned for our commitment to quality, innovation, and client success.</p>
      </section>
      ...
      <section>
        <h2 className="text-2xl md:text-3xl font-bold mb-4">Why Work With ProtoLaunch?</h2>
        <ul className="list-disc list-inside space-y-2 text-base md:text-lg">
